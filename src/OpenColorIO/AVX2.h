...
template <BitDepth BD>
inline void avx2RGBALoad(const typename BitDepthInfo<BD>::Type *in, __m256& r, __m256& g, __m256& b, __m256& a);
...
template <>
inline void avx2RGBALoad<BIT_DEPTH_UINT10>(const uint16_t *in, __m256& r, __m256& g, __m256& b, __m256& a)
{
    avx2RGBALoadU16<BIT_DEPTH_UINT10>(in, r, g, b, a);
}

template <>
inline void avx2RGBALoad<BIT_DEPTH_UINT12>(const uint16_t *in, __m256& r, __m256& g, __m256& b, __m256& a)
{
    avx2RGBALoadU16<BIT_DEPTH_UINT12>(in, r, g, b, a);
}

template <>
inline void avx2RGBALoad<BIT_DEPTH_UINT16>(const uint16_t *in, __m256& r, __m256& g, __m256& b, __m256& a)
{
    avx2RGBALoadU16<BIT_DEPTH_UINT16>(in, r, g, b, a);
}

template <>
inline void avx2RGBALoad<BIT_DEPTH_F16>(const half *in, __m256& r, __m256& g, __m256& b, __m256& a)
{
...
template <>
inline void avx2RGBALoad<BIT_DEPTH_F32>(const float *in, __m256& r, __m256& g, __m256& b, __m256& a)
{
